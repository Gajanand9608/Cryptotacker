...
import com.learning.cryptotracker.R
import com.learning.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.learning.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.learning.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import com.learning.cryptotracker.crypto.presentation.models.toDisplayableNumber
import com.learning.cryptotracker.ui.theme.CryptoTrackerTheme
import com.learning.cryptotracker.ui.theme.greenBackground
        ...
        Column(
            ...
            AnimatedVisibility(visible = coin.coinPriceHistory.isNotEmpty()) {
                ...
                LineChart(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .aspectRatio(16/9f).onSizeChanged {
